...
Future<void> main(List<String> args) async {
  await build(args, (buildConfig, buildOutput) async {
    ...
    for (String arch in archKeys) {
      ...
      if (!sdkDownloadUrls[targetOs]!['libvision']!.containsKey(arch)) {
        continue;
      }
      final assetUrl = sdkDownloadUrls[targetOs]!['libvision']![arch]!;
      ...
      buildOutput.addAsset(
        NativeCodeAsset(
          package: 'mediapipe_vision',
          name: '../third_party/mediapipe/mediapipe_vision_bindings.dart',
