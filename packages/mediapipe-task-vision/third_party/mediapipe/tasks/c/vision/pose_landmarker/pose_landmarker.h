...
#include "../../../../../../../mediapipe-core/third_party/mediapipe/tasks/c/core/common.h"
#include "pose_landmarker_result.h"
...
typedef void (*result_callback_fn)(struct PoseLandmarkerResult* result,
                                   const struct MpImage* image, int64_t timestamp_ms,
                                   char* error_msg);
...
MP_EXPORT int pose_landmarker_detect_image(void* landmarker,
                                           const struct MpImage* image,
                                           struct PoseLandmarkerResult* result,
                                           char** error_msg);
...
MP_EXPORT void pose_landmarker_close_result(struct PoseLandmarkerResult* result);
